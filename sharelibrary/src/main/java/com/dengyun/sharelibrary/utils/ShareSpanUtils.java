 ...
 */
public final class ShareSpanUtils {
     ...
     *             </ul>
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setStrikethrough() {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setUnderline() {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setSuperscript() {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setSubscript() {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link ShareSpanUtils} instance
     */
    public ShareSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(ShareUtil.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            ShareUtil.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(ShareUtil.getApp().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(ShareUtil.getApp(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
